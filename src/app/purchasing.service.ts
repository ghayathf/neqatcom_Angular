...
export class PurchasingService {
  ...
  GetAllPaymentsById(id: any) {
    return new Promise<void>((resolve, reject) => {
      this.spinner.show();
      this.http.get(`${environment.apiUrl}/Purchasing/GettAllPayments/` + id).subscribe(
        (res) => {
          this.Payments = res
  ...
  ForgiveLoanee(id: any) {
    return new Promise<void>((resolve, reject) => {
      this.spinner.show();
      this.http.put(`${environment.apiUrl}/Purchasing/ForGiveMonthly/${id}`,{}).subscribe(
        () => {
          this.spinner.hide();
  ...
  PayCash(id: any) {
    return new Promise<void>((resolve, reject) => {
      this.spinner.show();
      this.http.put(`${environment.apiUrl}/Purchasing/PayCash/${id}`,{}).subscribe(
        () => {
          this.spinner.hide();
  ...
  PayOnline(id: any) {
    return new Promise<void>((resolve, reject) => {
      this.spinner.show();
      this.http.put(`${environment.apiUrl}/Purchasing/PayOnline/${id}`,{}).subscribe(
        () => {
          this.spinner.hide();
          this.toaster.success("Successful Payment")
          resolve()
