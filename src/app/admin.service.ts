...
export class AdminService {
  ...
  GetAllComplaints() {
    ...
    return new Promise<void>((resolve, reject) => {
      this.http
        .get(`${environment.apiUrl}/Admin/GetLenderStoresComplaints`)
        .subscribe({
          next: (res) => {
            this.complaints = res;
            this.spinner.hide();
  ...
  GetLoaneesStatistics() {
    return new Promise<void>((resolve, reject) => {
      this.http
        .get(`${environment.apiUrl}/Admin/AdminStatisticsLoanee`)
        .subscribe({
          next: (res) => {
  ...
  GetLendersStatistics() {
    ...
    return new Promise<void>((resolve, reject) => {
      this.http
        .get(`${environment.apiUrl}/Admin/lenderAdminStatistics`)
        .subscribe({
          next: (res) => {
  ...
  GetComplaintsStatistics() {
    return new Promise<void>((resolve, reject) => {
      this.http
        .get(`${environment.apiUrl}/Admin/complaintsStatistics`)
        .subscribe({
          next: (res) => {
  ...
  GetCategoriesStatistics() {
    ...
    return new Promise<void>((resolve, reject) => {
      this.http
        .get(`${environment.apiUrl}/Admin/categoriesStatistics`)
        .subscribe({
          next: (res) => {
  ...
  DeleteComplaint(CID: any) {
    ...
    return new Promise<void>((resolve, reject) => {
      this.http
        .put(`${environment.apiUrl}/Admin/deleteComplaint/${CID}`, {})
        .subscribe({
          next: (res) => {
            this.spinner.hide();
  ...
  ManageLoaneeComplaints(lenderid: number, complaintsID: any) {
    return new Promise<void>((resolve, reject) => {
      this.http
        .post(
          `${environment.apiUrl}/Admin/ManageLoaneeComplaints/` +
            lenderid +
            '/' +
            complaintsID,
          {}
  ...
  CheckFiveDays() {
    ...
    return new Promise<void>((resolve, reject) => {
      this.http
        .post(`${environment.apiUrl}/Admin/CheckFiveDays`, {})
        .subscribe({
          next: () => {
            this.spinner.hide();
            resolve();
  ...
  GetCreditScoreCounterCharts() {
    ...
    return new Promise<void>((resolve, reject) => {
      this.http
        .get(`${environment.apiUrl}/Admin/LoaneeCreditScores`)
        .subscribe({
          next: (res) => {
  ...
  ManageLenderComplaints(loaneeid: number, complaintsID: any) {
    return new Promise<void>((resolve, reject) => {
      this.http
        .post(
          `${environment.apiUrl}/Admin/ManageLenderComplaints/` +
            loaneeid +
            '/' +
            complaintsID,
          {}
