...
export class OfferService {
  ...
  GetAllOffersById(id: any) {
    return new Promise<void>((resolve, reject) => {
      this.spinner.show();
      this.http.get(`${environment.apiUrl}/Offer/GetAllOffersById/` + id).subscribe(
        (res) => {
          this.offersById = res
          this.spinner.hide();
          resolve()
  ...
  DeleteOffer(id: any) {
    return new Promise<void>((resolve, reject) => {
      this.http.delete(`${environment.apiUrl}/Offer/DeleteOffer/` + id).subscribe(
        (res) => {
          resolve()
        },
        (err) => {
  ...
  GetOffersForLenderMain(lendId: any) {
    return new Promise<void>((resolve, reject) => {
      this.spinner.show();
      this.http.get(`${environment.apiUrl}/Offer/GetOffersForLenderMain/` + lendId).subscribe(
        (res) => {
  ...
  CreateOffer(Offer: any) {
    ...
    return new Promise<void>((resolve, reject) => {
      Offer.lenderid = parseInt(Offer.lenderid)
      this.spinner.show();
      this.http.post(`${environment.apiUrl}/Offer/CreateOffer`, Offer).subscribe({
        next: () => {
          this.spinner.hide();
          resolve();
