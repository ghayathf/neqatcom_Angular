...
export class PostponeRequestsComponent {
  ...
  async RejectRequest() {
    ...
    this.m =
      'We are sorry to let you know that your Postpone request from ' +
      this.lenderName +
      ' in Neqatcom has been rejected!';
  ...
  async AcceptRequest() {
    ...
    this.m =
      'We would like to inform you that  your Postpone request from ' +
      this.lenderName +
      ' in Neqatcom has been Accepted! , Your Payment date should be on ' +
      formattedDate;
    await this.sendEmail(this.Email, this.first_name, this.m, this.s);
    this.CreateNotificationForm.controls['userid'].setValue(this.userid);
    this.CreateNotificationForm.controls['notificationsmessage'].setValue(
      'Accept Postpone Request'
    );
    await this.notification.CreateNotification(
      this.CreateNotificationForm.value
    );
